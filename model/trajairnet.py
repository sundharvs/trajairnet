...
class TrajAirNet(nn.Module):
    def __init__(self, args):
        ...
        self.gat = GAT( nin=gat_in, nhid = graph_hidden, nout = gat_out, alpha = alpha, nheads = n_heads, num_intent_classes = num_intent_classes)
    ...
    def forward(self, x, y, adj, context, intent_labels, sort=False):        
        ...
        # Embed intent labels for all agents (convert 1-16 to 0-15 indices)
        ...
        gat_output = self.gat(gat_input, adj, intent_labels)
