...
def run_sweep():
    ...
    full_config = {
        ...
        'alpha': config.alpha,
        'cvae_hidden': 128,  # Use default
        'cvae_channel_size': 128,  # Use default
        'cvae_layers': 2,
        'mlp_layer': 32,
...
def main():
    ...
    with open('sweep_config_intent_attention_head.yaml', 'r') as f:
        sweep_config = yaml.safe_load(f)
    
    # Create sweep
    sweep_id = wandb.sweep(sweep_config, project="trajairnet-intent-attention-head")
